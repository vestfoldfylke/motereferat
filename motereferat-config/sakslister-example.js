...
export const SMART_SAKSLISTER_CONFIG = [
  {
    ...
    DEMO_MODE: false, // Skriver ingenting til eksterne systemer, kun for testing. Slett demo_pdf for møtet hvis du vil kjøre samme møte igjen, hvis ikke tar den neste
